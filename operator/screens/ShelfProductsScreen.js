...
class ShelfProductsHeader extends React.Component {
...
export default class ShelfProductsScreen extends React.Component {

    static navigationOptions = {
        title: "Shelf",
        headerTitle: withNavigation(ShelfProductsHeader),
            ...
            fetch(`${networkUrl}/products/business/${businessId}`, {
                ...
                .then((json) => {
                    if (json.error) {
                        ...
                        json = json.filter((product) => product.shelf)
    ...
    async _delete(productId) {
        ...
        try {
            const result = await fetch(`${networkUrl}/products/unshelf/${productId}`, {
                headers: {
            ...
            if (json.result == "ok") {
                ...
                alert("Error: can't unshelf product")
            }
        } catch (error) {
            alert(error)
        }
